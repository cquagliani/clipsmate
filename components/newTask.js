        ...
        <div className='mt-1'>
            {newItemToggle && (
                <li className="list-none mb-4">
                    <div className="flex flex-row justify-between border border-solid bg-light border-blue gap-2 p-4">
                        <div className="flex flex-col justify-center gap-2 w-full px-2">
                            ...
                            <div className="flex flex-row items-center justify-end gap-2 w-full py-2">
                                <button className="flex items-center justify-center w-[85px] h-[38px] px-2 border border-solid border-blue rounded-lg bg-light hover:shadow-2xl font-bold text-sm text-blue" onClick={showNewItemComponent}>Cancel</button>
