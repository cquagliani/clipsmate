function GhostListItem() {
    return (
        <button class="flex flex-col items-center border-2 border-solid border-gray-600 border-opacity-10 rounded-xl gap-2 p-6 min-w-fit">
                            <svg
                class="opacity-30"
            ...
            <p class="opacity-30">Add a new list item</p>
        </button>
    );
}
