...
function NewListItem() {
    ...
    //                 <input className="font-bold text-xl border border-solid border-black bg-transparent rounded-lg px-2" placeholder="Label" onChange={(e) => {setItemLabel(e.target.value)}} />     
    ...
    //             </div>
    //             <div className="">
    //                 <input className="border border-solid border-black bg-transparent rounded-lg px-2 w-[85%] h-[70px]" placeholder="Your Clip goes here!" onChange={(e) => {setItemText(e.target.value)}} />    
    //             </div>
    //         </div>
    //     </li>
    // );
        ...
        <div>
            ...
            {newItemToggle && (
                <button onClick={showNewItemComponent} className="flex flex-col items-center border-2 border-solid border-gray-600 border-opacity-10 rounded-xl gap-2 p-6 min-w-fit w-full">
                    ...
                    <p className="opacity-30">Cancel</p>
                </button>
            )}
        </div>
    );
