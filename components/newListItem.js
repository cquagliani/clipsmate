            ...
            {!newItemToggle && (
                <div className="pl-2 mt-2 group">
                    <button className="flex flex-row items-center justify-start mt-0 gap-4" onClick={showNewItemComponent}>
                        <div className="p-1 group-hover:bg-zinc-800 group-hover:rounded-full">
                            <svg
                        ...
                        <p className="text-sm text-zinc-500 font-light group-hover:text-zinc-900">Add task</p>
                    </button>
                </div>
            )}
            {newItemToggle && (
                <button onClick={showNewItemComponent} className="flex flex-row items-center justify-center border-2 border-solid hover:shadow-lg hover:bg-red-500 hover:text-white gap-2 p-6 w-full">
                    <svg
                    className="hidden"
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
