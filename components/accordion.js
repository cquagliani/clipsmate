    ...
    <Accordion sx={{border: '1px solid'}}>
        ...
        <AccordionDetails>
            ...
            <div className="flex flex-row justify-end items-center gap-4">
                ...
                <button className="bg-transparent p-2 border-2 border-solid border-red-500 font-bold hover:shadow-lg hover:bg-red-500 hover:text-white" onClick={() => deleteItem(listId)}>Delete</button>
            </div>
        </AccordionDetails>
    </Accordion>
  )
