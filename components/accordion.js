    ...
    <Accordion sx={{border: '1px solid', marginTop: '0px'}} expanded={expandAll || expandItem} disableGutters={true}>
        ...
        <AccordionDetails>
            ...
            <div className="flex flex-row justify-end items-center gap-4">
                ...
                <button className="bg-transparent p-1 border-2 border-solid rounded-md border-error text-blue text-sm font-bold hover:shadow-lg hover:text-error" onClick={() => deleteItem(listId)}>Delete</button>
            </div>
        </AccordionDetails>
    </Accordion>
  )
